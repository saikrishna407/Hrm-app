    ...
    <View style={styles.item}>
      <View
        ...
        <View style={{ justifyContent: 'flex-start', margin: 20,marginTop:5}}>
          ...
          <Text style={styles.title}>Type: Sick Leave</Text>
          <View style={{top: 20}}>
            <Text style={styles.title}>Fri 07 to Wed 12 | 4 Days</Text>
          </View>
        </View>
        <View style={{flexDirection: 'row', alignSelf: 'center'}}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('DetailsPage')}>
            <Text style={styles.title2}>Rejected</Text>
          </TouchableOpacity>
      ...
      <View style={styles.item}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={styles.textStyle}>Apply Leave</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.button, styles.buttonOpen]}
            onPress={() => setModalVisible1(true)}>
            <Text style={styles.textStyle}>Search Leave</Text>
          </TouchableOpacity>
        </View>
        <View
          style={{
